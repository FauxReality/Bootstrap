...
funtion PlansTab({customers,plans,setPlans,services,biz}){const [f,setF]=useState({id:'',customerId:'',name:'',frequency:'weekly',interval:1,startDate:today(),nextDate:today(),endDate:'',services:[],items:[],dueRule:{daysAfter:7},active:true});
...
// === UI tokens / primitives (keep outside App) ===
const BTN = {
  base: "inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50",
  primary: "bg-blue-600 text-white hover:bg-blue-700",
  secondary: "bg-gray-200 text-gray-900 hover:bg-gray-300",
  ghost: "border text-gray-700 hover:bg-gray-50",
  danger: "bg-red-600 text-white hover:bg-red-700",
};
const INPUT = "w-full border rounded-xl px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500";
const LABEL = "block text-sm font-medium mb-1";
const CARD  = "bg-white rounded-2xl shadow p-4 md:p-6";

// Optional tiny primitives
const H2      = ({children}) => <h2 className="text-xl font-semibold mb-4">{children}</h2>;
...
function saveEdit(){
  ...
  <section className="bg-white rounded-2xl shadow p-4 md:p-6">
    <div id="invoice-print">
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6 text-base">
